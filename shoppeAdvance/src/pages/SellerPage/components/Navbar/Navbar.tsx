        ...
        <ul className="space-y-2 font-medium">
          ...
          <li>
            ...
            <ul id="order-dropdown" className={isOrderDropdownOpen ? "py-2 space-y-2" : "hidden py-2 space-y-2"}>
              ...
              <li>
                <a href="#" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Giao Hàng Loạt</a>
              </li>
              
              <li>
                <a href="#" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Đơn Hủy</a>
              </li>
              <li>
                <a href="#" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Trả Hàng/Hoàn Tiền</a>
              </li>
              <li>
          ...
          <li>
            ...
            <ul id="product-dropdown" className={isProductDropdownOpen ? "py-2 space-y-2" : "hidden py-2 space-y-2"}>
              ...
              <li>
                <a href="#" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Sản Phẩm Vi Phạm</a>
              </li>
              <li>
