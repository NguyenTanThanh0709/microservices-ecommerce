  ...
  return (
    <div className='bg-gray-200 py-6'>
        ...
        <div className='container'>
          ...
          <div className='mt-6 grid grid-cols-2 gap-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-4'>
            <div className='flex'>
            ...
            <div className='mx-10'>
                ...
                <div className='border-slate-950 flex items-center my-6'>
                  <svg enableBackground="new 0 0 15 15" viewBox="0 0 15 15" x="0" y="0" strokeWidth="0" className="w-10 shopee-svg-icon">
                  ...
                  <div className="mx-4">Sản Phẩm:</div>
                  <p>120</p>
                </div>
                ...
                <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                  ...
                  <div className="mx-4">Đang theo dõi:</div>
                  <p>120</p>
                </div>                
                ...
                <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                  ...
                  <div className="mx-4">Tỉ lệ phản hồi:</div>
                  <p>120</p>
                </div>
            </div>
            ...
            <div className='mx-10'>
                ...
                <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                  ...
                  <div className="mx-4">Người theo dõi:</div>
                  <p>2 triệu người</p>
                </div>
                ...
                <div className='border-slate-950 flex items-center my-6'>
                  ...
                  <div className="mx-4">Đánh Giá:</div>
                  <p>4.9 triệu người</p>
                </div>                
                ...
                <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                  ...
                  <div className="mx-4">Tham Gia:</div>
                  <p>7 năm trước</p>
                </div>
            </div>
